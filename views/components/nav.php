            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/"
                            class="<?= isActiveUrl('/') ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white"?> rounded-md px-3 py-2 text-sm font-medium"
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        ...
                        <div class="absolute hidden right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                            ...
                            <a href="/about" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                                id="user-menu-item-1">Settings</a>
                            <a href="/contact" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
